...
# Problem : Ozellikleri belirtildiginde kisilerin diyabet hastası olup olmadıklarını tahmin edebilecek bir makine
# ogrenmesi modeli gelistirilmesi istenmektedir. Modeli gelistirmeden once gerekli olan veri analizi ve ozellik
# muhendisligi adimlarini gerceklestirmeniz beklenmektedir.

# Veri seti ABD'deki Ulusal Diyabet-Sindirim-Bobrek Hastalıkları Enstituleri'nde tutulan buyuk veri setinin
# parcasıdır. ABD'deki Arizona Eyaleti'nin en buyuk 5. sehri olan Phoenix sehrinde yasayan 21 yas ve uzerinde olan
# Pima Indian kadinları uzerinde yapilan diyabet arastırmasi icin kullanilan verilerdir. 768 gozlem ve 8 sayısal
# bagimsiz degiskenden olusmaktadır. Hedef degisken "outcome" olarak belirtilmis olup; 1 diyabet test sonucunun
# pozitif olusunu, 0 ise negatif olusunu belirtmektedir.

# Pregnancies                   : Hamilelik sayıisi
# Glucose                       : Glikoz
# BloodPressure                 : Kan basıncı (Diastolic(Kucuk Tansiyon))
...
# GOREV 2: FEATURE ENGINEERING
    # Adım 1:  Eksik ve aykiri degerler icin gerekli islemleri yapiniz. Veri setinde eksik gozlem bulunmamakta
    # ama Glikoz, Insulin vb. degiskenlerde 0 degeri iceren gozlem birimleri eksik degeri ifade ediyor olabilir.
    # Ornegin; bir kisinin glikoz veya insulin degeri 0 olamayacaktir. Bu durumu dikkate alarak sifir degerlerini ilgili
    # degerlerde NaN olarak atama yapip sonrasinda eksik degerlere islemleri uygulayabilirsiniz.
